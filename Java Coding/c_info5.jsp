...
<%
   try
	...
	ResultSet rs=stmt.executeQuery("select * from Dealer5");
	out.println("<center><h3>Mother Board Details</h3><hr color='blue'>");
	...
	out.println("<tr><th>ItemCode</th><th>ItemName</th>  <th>Model</th> <th>Specification</th>  <th>Warenty Period</th><th>Cost</th>");
		while(rs.next())
	 {
	       out.println("<tr><td><select name='keyid5' multiple='multiple' size='1' <option>"+rs.getString(1)+"<option></td>");
