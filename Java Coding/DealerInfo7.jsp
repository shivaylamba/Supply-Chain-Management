...
<%
   try
	...
	ResultSet rs=stmt.executeQuery("select * from Dealer7");
	out.println("<center><h3>Processor Details</h3><hr color='blue'>");
	...
	out.println("<tr><th>ItemCode</th><th>ItemName</th>  <th>Model</th> <th>Specification</th>  <th>Warranty Period</th><th>Cost</th>");
		while(rs.next())
	 {
	       out.println("<tr><td><select name='keyid7' multiple='multiple' size='1' <option>"+rs.getString(1)+"<option></td>");
