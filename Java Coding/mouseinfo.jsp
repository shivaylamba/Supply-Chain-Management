...
<%
   try
	...
	ResultSet rs=stmt.executeQuery("select * from Dealer2");
	out.println("<center><h3>Mouse Details</h3><hr color='blue'>");
	out.println("<table border='15%' width='100%'>");
	out.println("<tr><th>ItemCode</th><th>ItemName</th>  <th>Model</th> <th>Specification</th>  <th>WarraSnty Period</th><th>Cost</th>");
		while(rs.next())
	 {
