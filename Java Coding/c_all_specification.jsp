...
<%! 
PreparedStatement ps=null, ps1=null, ps2=null, ps3=null, ps4=null, ps5=null, ps6=null, ps7=null, ps8=null, ps9=null,ps80=null,ps81=null, ps82=null, ps83=null,ps84=null,pwds=null;	
ResultSet rs1=null, rs2=null, rs3=null, rs4=null, rs5=null, rs6=null, rs7=null, rs8=null, rs9=null, rs80=null, rs81=null, rs82=null, rs83=null,rs84=null,rwds=null;
...
<%
      ...
      try
        {
					...
					session.setAttribute("kid1",keyid1);
    ...
    rs1 =ps1.executeQuery(); 
				...
				if(rs1.next())
				 {   
						...
						ps  = cn.prepareStatement("insert into c_totalinfo values(?,?,?,?,?,?,?)");
						...
						ps9=cn.prepareStatement("select * from c_totalinfo");
    ...
    rs2 =ps2.executeQuery();
						 ...
						 if(rs2.next())
						{
							...
							ps8=cn.prepareStatement("select * from c_totalinfo");
						...
						if(rs3.next())
							{
								...
								ps80=cn.prepareStatement("select * from c_totalinfo");
    ...
    rs4 =ps4.executeQuery();
					...
					if(rs4.next())
							...
							ps  = cn.prepareStatement("insert into c_totalinfo values(?,?,?,?,?,?,?)");
                                        ...
                                        ps81=cn.prepareStatement("select * from c_totalinfo");
	...
	out.println("<table border='1%' width='100%'>");
					...
					ps  = cn.prepareStatement("insert into c_totalinfo values(?,?,?,?,?,?,?)");
										...
										int i =ps.executeUpdate();
                                            ...
                                            ps82=cn.prepareStatement("select * from c_totalinfo");
		...
		out.println("<table border='1%' width='100%'>");
						...
						ps  = cn.prepareStatement("insert into c_totalinfo values(?,?,?,?,?,?,?)");
										...
										ps.setString(7,password);
                                            ...
                                            ps83=cn.prepareStatement("select * from c_totalinfo");
			...
			rs7 =ps7.executeQuery();
	    	    ...
	    	    ps  = cn.prepareStatement("insert into c_totalinfo values(?,?,?,?,?,?,?)");
										...
										int i =ps.executeUpdate();
                                            ...
                                            ps84=cn.prepareStatement("select * from c_totalinfo");
...
%>
<a href='c_req_specification.jsp' style='text-decoration:none'>Back</a>
</body>